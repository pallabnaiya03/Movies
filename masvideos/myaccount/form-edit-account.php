...
<form class="masvideos-EditAccountForm edit-account" action="" method="post" <?php do_action( 'masvideos_edit_account_form_tag' ); ?> >
	...
	<p class="masvideos-form-row masvideos-form-row--first fieldset-first-name">
		<label for="account_first_name"><?php esc_html_e( 'First name', 'vodi' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="masvideos-form-row masvideos-form-row--last fieldset-last-name">
		<label for="account_last_name"><?php esc_html_e( 'Last name', 'vodi' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="masvideos-form-row masvideos-form-row--wide fieldset-display-name">
		<label for="account_display_name"><?php esc_html_e( 'Display name', 'vodi' ); ?>&nbsp;<span class="required">*</span></label>
		<input type="text" class="masvideos-Input masvideos-Input--text input-text" name="account_display_name" id="account_display_name" value="<?php echo esc_attr( $user->display_name ); ?>" /> <span><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'vodi' ); ?></em></span>
	</p>

	<p class="masvideos-form-row masvideos-form-row--wide fieldset-email">
		<label for="account_email"><?php esc_html_e( 'Email address', 'vodi' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<h2 class="password-fields"><?php echo esc_html_e( 'Password change', 'vodi' ); ?></h2><?php // @codingStandardsIgnoreLine ?>

	<p class="masvideos-form-row masvideos-form-row--wide fieldset-current-pass">
		<label for="password_current"><?php esc_html_e( 'Current password (leave blank to leave unchanged)', 'vodi' ); ?></label>
	...
	<p class="masvideos-form-row masvideos-form-row--wide fieldset-new-pass">
		<label for="password_1"><?php esc_html_e( 'New password (leave blank to leave unchanged)', 'vodi' ); ?></label>
	...
	<p class="masvideos-form-row masvideos-form-row--wide fieldset-confirm-pass">
		<label for="password_2"><?php esc_html_e( 'Confirm new password', 'vodi' ); ?></label>
	...
	<p class="masvideos-form-submit">
		...
		<button type="submit" class="masvideos-Button button" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'vodi' ); ?>"><?php esc_html_e( 'Save changes', 'vodi' ); ?></button>
